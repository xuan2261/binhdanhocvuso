const quizData = [
  ...
  {
    "question": "1. Đâu không phải là quy tắc ứng xử của cơ quan nhà nước trên mạng xã hội?",
    "options": {
	...
	{
		"question": "2. Chuyển đổi số là gì?",
		"options": {
	...
	{
		"question": "3. Kỹ năng quan trọng nhất cho cán bộ trong chuyển đổi số là gì?",
		"options": {
			"a": "Lái xe",
	...
	{
		"question": "4. Hệ thống thông tin liên lạc hiện đại của quân đội sử dụng công nghệ nào?",
		"options": {
			"a": "5G",
			"b": "Mạng radio mật mã",
			"c": "Vệ tinh quân sự",
	...
	{
		"question": "6. Người dùng có thể dùng camera thông minh để làm gì?",
		"options": {
	...
	{
		"question": "7. Phát biểu nào sau đây đúng về phòng chống tấn công mạng trong quân đội?",
		"options": {
	...
	{
		"question": "8. Các hành vi nào sau đây là vi phạm an toàn thông tin cá nhân?",
		"options": {
	...
	{
		"question": "9. Khi nhận được cuộc gọi lạ, xưng là cán bộ Công an yêu cầu cung cấp các thông tin cá nhân, tài khoản ngân hàng,... để cấp tài khoản định danh điện tử. Có nên thực hiện không?",
		"options": {
	...
	{
		"question": "10. AI có thể tăng cường hiệu quả công tác chính trị như thế nào?",
		"options": {
	...
	{
		"question": "12. AI được ứng dụng trong giáo dục để làm gì?",
		"options": {
			"a": "Phát wifi",
	...
	{
		"question": "1. Phát biểu đúng nhất về lợi ích chuyển đổi số trong học tập là gì?",
		"options": {
	...
	{
		"question": "2. Ứng dụng VNeID có chức năng gì?",
		"options": {
	...
	{
		"question": "3. Hiểu thế nào về khái niệm dịch vụ công trực tuyến của cơ quan nhà nước?",
		"options": {
	...
	{
		"question": "4. Thiết bị đeo thông minh (smartwatch, vòng đeo tay sức khỏe) có thể hỗ trợ theo dõi sức khỏe như thế nào?",
		"options": {
	...
	{
		"question": "8. Khi nào thì tài khoản Định danh điện tử công dân bị khóa?",
		"options": {
	...
	{
		"question": "10. Công nghệ AI nào thường được dùng để phân tích hình ảnh y tế?",
		"options": {
	...
	{
		"question": "11. AI có thể hỗ trợ bác sĩ như thế nào trong chẩn đoán bệnh?",
		"options": {
	...
	{
		"question": "15. Trên Android, thao tác tắt máy đúng là như thế nào?",
		"options": {
	...
	{
		"question": "1. Chuyển đổi số trong kinh tế vi mô giúp gì cho người dân?",
		"options": {
	...
	{
		"question": "2. Ba trụ cột của chuyển đổi số là gì?",
		"options": {
	...
	{
		"question": "3. Đến năm 2030, mục tiêu tỷ lệ dân số có tài khoản thanh toán điện tử là bao nhiêu?",
		"options": {
			"a": "Trên 90%",
			"b": "Trên 70%",
			"c": "Trên 60%",
	...
	{
		"question": "4. Công nghệ nào nâng cao hiệu quả quản lý cán bộ chiến sĩ trong quân đội?",
		"options": {
	...
	{
		"question": "6. Các loại hình thương mại điện tử phổ biến?",
		"options": {
	...
	{
		"question": "7. Được phép truy cập thư điện tử nội bộ trên máy tính nào?",
		"options": {
	...
	{
		"question": "10. AI giúp gì khi huấn luyện sỹ quan chỉ huy?",
		"options": {
	...
	{
		"question": "11. AI giúp giảm thiểu gian lận bằng cách nào?",
		"options": {
			"a": "Tăng thuế",
			"b": "Phân tích hành vi",
	...
	{
		"question": "12. AI thường xuất hiện trong ứng dụng nào?",
		"options": {
			"a": "Máy tính bỏ túi",
			"b": "Excel",
			"c": "Wordpad",
	...
	{
		"question": "14. Trên iPhone, để chia sẻ Internet qua Bluetooth, cần thao tác gì?",
		"options": {
	...
	{
		"question": "19. Nguyên tắc cấp quyền cho người dùng?",
		"options": {
			"a": "Phân tán dữ liệu",
			"b": "Tối thiểu quyền",
			"c": "Truy cập mở",
